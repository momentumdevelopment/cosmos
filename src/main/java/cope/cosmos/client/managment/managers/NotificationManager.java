...
public class NotificationManager extends Manager {
    ...
    public enum Type {
        INFO(new ResourceLocation("panels", "textures/icons/info.png")), SAFETY(new ResourceLocation("panels", "textures/icons/warning.png")), WARNING(new ResourceLocation("panels", "textures/icons/warning.png"));
