...
public class PresenceManager extends Manager implements IUtility {
    ...
    private static final String[] presenceDetails = {
            ...
            "Selling panels vouches for discord nitro!",
            ...
            "Dumping panels (215/331) classes",
        ...
        presenceThread = new Thread(() -> {
            while (!Thread.currentThread().isInterrupted()) {
                try {
                    ...
                    richPresence.smallImageKey = "panels";
