...
public class ModuleComponent extends Component implements IUtility, GUIUtil {
    ...
    public void drawComponent(Vec2f position) {
        ...
        if (getModule() != null) {
            ...
            if (getModule().getSettings().size() > 0) {
                ...
                mc.getTextureManager().bindTexture(new ResourceLocation("panels", "textures/icons/dots.png"));
