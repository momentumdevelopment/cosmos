package cope.cosmos.client.ui.panels.navigation.navs;

import cope.cosmos.client.ui.panels.navigation.Navigation;
...
public class ControlNavigation extends Navigation implements IUtility, GUIUtil {
    ...
    public void drawNavigation() {
        ...
        // logo
        glColor4d(1, 1, 1, 1);
        mc.getTextureManager().bindTexture(new ResourceLocation("panels", "textures/imgs/logotransparent.png"));
