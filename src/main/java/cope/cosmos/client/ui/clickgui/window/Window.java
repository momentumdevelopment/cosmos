...
import cope.cosmos.client.ui.clickgui.feature.WindowFeature;
...
public class Window extends Element {
    ...
    public Window(int x, int y, int width, int height, String title, ClickGuiScreen mainScr, WindowFeature... features) {
        this.x = x;
        this.y = y;
        this.width = width;
        this.height = height;
