...
public class ColorComponent extends TypeComponent<Color> implements IUtility {
    ...
    public void drawColorPicker(int x, int y, float width, float height) {
        mc.getTextureManager().bindTexture(new ResourceLocation("panels", "textures/imgs/picker.png"));
