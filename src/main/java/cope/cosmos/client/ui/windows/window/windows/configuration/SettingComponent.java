...
import cope.cosmos.client.ui.windows.window.windows.ConfigurationWindow.Page;
import cope.cosmos.client.ui.windows.window.windows.ErrorWindow;
import cope.cosmos.client.ui.windows.window.windows.configuration.types.BooleanComponent;
import cope.cosmos.client.ui.windows.window.windows.configuration.types.ColorComponent;
import cope.cosmos.client.ui.windows.window.windows.configuration.types.EnumComponent;
import cope.cosmos.client.ui.windows.window.windows.configuration.types.NumberComponent;
...
public class SettingComponent extends Component implements IUtility {
