...
public class Window implements GUIUtil, IUtility {
    ...
    public Window(String name, Vec2f position, float width, float height, boolean pinned) {
        ...
        this.width = width;
        this.height = height;
        this.icon = new ResourceLocation("panels", "textures/icons/warning.png");
        this.pinned = pinned;
    }
    ...
    public void drawWindow() {
        ...
        glPushMatrix();
        mc.getTextureManager().bindTexture(new ResourceLocation("panels", "textures/icons/cancel.png"));
