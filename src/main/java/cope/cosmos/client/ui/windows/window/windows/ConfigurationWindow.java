...
import cope.cosmos.client.ui.windows.window.TabbedWindow;
import cope.cosmos.client.ui.windows.window.windows.configuration.Component;
import cope.cosmos.client.ui.windows.window.windows.configuration.ModuleComponent;
import cope.cosmos.client.ui.windows.window.windows.configuration.SettingComponent;
...
public class ConfigurationWindow extends TabbedWindow {
    ...
    public ConfigurationWindow(String name, Vec2f position) {
        super(name, new ResourceLocation("panels", "textures/icons/client.png"), position, 400, 300, true);
    ...
    public void drawWindow() {
        ...
        glPushMatrix();
        glColor4d(1, 1, 1, 1);
        mc.getTextureManager().bindTexture(new ResourceLocation("panels", "textures/icons/back.png"));
    ...
    public void onSettingChange(SettingEnableEvent event) {
        // update our columns when settings are updated, in case we changed visibility
        updateColumns();
    }
