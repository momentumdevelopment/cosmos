package cope.cosmos.client.ui.windows.window.windows.configuration.types;
...
import cope.cosmos.client.ui.windows.window.windows.configuration.TypeComponent;
...
public class EnumComponent extends TypeComponent<Enum<?>> implements IUtility {
    ...
    public void drawType(Vec2f position, float width, float height, float boundHeight) {
        ...
        mc.getTextureManager().bindTexture(new ResourceLocation("panels", "textures/icons/dropdown.png"));
    ...
    public static class ModeComponent implements GUIUtil, IUtility {
