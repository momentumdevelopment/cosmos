...
public class Replenish extends Module {
    ...
    public static Setting<Boolean> wait = new Setting<>("Wait", false).setDescription("If the item is a crystal and AutoCrystal is on, it will wait for AutoCrystal to be turned off");
    ...
    public void onTick() {
        ...
        if (refillSlot == -1) {
            ...
            if (timer.passedTime(delay.getValue().longValue(), Timer.Format.MILLISECONDS)) {
                ...
                // replenish
                replenish(refillSlot, hotbar.get(refillSlot));
     ...
     */
    private void replenish(int slot, ItemStack stack) {
