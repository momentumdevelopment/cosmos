...
//        float t2 = field(p2, freqs[3], 18);
        ...
        gl_FragColor = vec4(vec4(mix(freqs[3]-.5, 1., 1.0) * vec4(freqs[2] * t * t* t * color[0], freqs[1] * t * t * color[1], freqs[3]*t * color[2], 1.0) +c2+starcolor).rgb, color.a);
    }
